...
import com.acorn5.booking.model.Book;

@Service
public class NaverBookService {
	 private static String clientID = "hqIK81ATna87kVfkpjD9";
	    private static String clientSecret = "pXqyhElpGp";
	 
	    //display ==> 몇개 출력
	    //start==>몇번쨰부터 (item)
	    public List<Book> searchBook(String d_cont, int display, int start, String d_catg, HttpServletRequest request, ModelAndView mav){
	        List<Book> list = null;
	        try {
	            URL url;
