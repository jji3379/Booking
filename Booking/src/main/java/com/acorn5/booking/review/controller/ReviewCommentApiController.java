...
public class ReviewCommentApiController {
	// by남기, 의존객체 DI 을 필드에 선언해둔다_210303
		...
		@RequestMapping(value = "/review/reply/{id}", method = RequestMethod.PUT)
		public void update(@PathVariable Long replyId, ReviewDtl dto) {
			// by남기, 수정할 리뷰의 정보를 dto에서 가져온다_210303
			service.updateComment(replyId, dto);
		}
