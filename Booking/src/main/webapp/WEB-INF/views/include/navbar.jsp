	...
	<div class="container-fluid">
		<div class="collapse navbar-collapse row justify-content-start" id="navbarSupportedContent" >
			<ul class="navbar-nav">
				...
				<li class="nav-item">
	               <a class="nav-link" href="${pageContext.request.contextPath }/pay/cart.do" style="font-weight:bold; font-size:20px; margin-left:35px; font-family: 'Roboto', sans-serif;">카트
