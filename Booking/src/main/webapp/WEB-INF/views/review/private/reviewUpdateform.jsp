			...
			<div class="form-body">
				<table>
					...
					<tr>
						...
						<td class="td-content"><textarea class="form-control" name="content" id="content" placeholder="최대 500자 까지 입력해 주세요.">${dto.content }</textarea><span class="textCount">0 / 500</span></td>
					</tr>
					<tr>
