...
<style>
	...
	.map_wrap {position:relative;width:1200px;height:700px;margin:0 auto 150px;/* border: 1px solid #41495c; */}
	#menu_wrap {position:absolute;top:0;left:0;bottom:0;width:250px;margin:91px 0 30px 10px;padding:5px;overflow-x:hidden;overflow-y:scroll;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
	...
	.partners{
		...
		border-left: 1px solid #41495c;
		border-right: 1px solid #41495c;
	}
	.partners > ul{
		display: table;
		margin:0 auto;
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    <select id="keyword">
	                	<option value="문고 서점">서점</option>
	                	<option value="영풍문고">영풍문고</option>
	                	<option value="yes24 중고서점">yes24 중고서점</option>
	                	<option value="교보문고">교보문고</option>
	                	<option value="알라딘 중고서점">알라딘 중고서점</option>
	                </select> 
	                <select id="location">
	                	...
	                	<option value="대구">서구</option>
	                	<option value="울산">울산</option>
	                	<option value="부산">부산</option>
	                	<option value="광주">광주</option>
	                	<option value="세종">세종</option>
	                </select> 
                    <button class="mapSearch" type="submit">검색하기</button> 
                </form>
            </div>
        </div>
        <hr>
...
function searchPlaces() {
    ...
    var keyword = document.getElementById('location').value + document.getElementById('keyword').value;
...
function addMarker(position, idx, title) {
    var imageSrc = 'https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
        imageSize = new kakao.maps.Size(50, 53),  // 마커 이미지의 크기
        imgOptions =  {
