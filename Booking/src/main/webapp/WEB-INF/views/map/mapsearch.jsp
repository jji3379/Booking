...
<jsp:include page="../include/resource.jsp"></jsp:include>
	<style>
		...
		#menu_wrap {float:left;position:absolute;width:23%;height:700px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:18px;border:2px solid #0f4c81;}
