...
<div class="orderContainer">
	...
	<div class="orderContents">
		...
		(총<em><font color="#135fa1"><c:out value="${sum }"></c:out></font></em>개)
		</span>
		</div>
		<div class="orderList">
		...
		<div class="orderAside">
			<div class="orderBox">
				<div class="topBox">
					<div class="priceBox">
						<c:forEach var="p" items="${list }">
						<c:set var= "sum" value="${sum + (p.d_price * p.count)}"></c:set>
						</c:forEach>
						<dt class="itemPriceL">상품 가격</dt>
						<dd>
							<div class="itemPriceR">
								<p class="itemSum"><c:out value="${sum }"></c:out><span>원</span></p>
							</div>
						</dd>
