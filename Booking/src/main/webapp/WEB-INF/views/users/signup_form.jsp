	 ...
	 <div class="signup-wrap">
	 	 ...
	 	 <div class="signup-body">
		 	...
		 	<div class="form-group">
		 		...
		 		<input class="form-control" type="password" name="pwd" id="signupPwd" placeholder="사용하실 비밀번호를 입력해주세요. (영문 소문자 5~10글자 이내)"/>
		 		<span id="pwdMsg" class="is-Blank"></span>
		 		<div class="invalid-feedback">비밀번호를 형식에 맞게 입력하세요</div>
		 	</div>
		 	<div class="form-group">
		 		<label for="pwd2" hidden>비밀번호 확인</label>
		 		<input class="form-control" type="password" name="pwd2" id="pwd2" placeholder="사용하실 비밀번호를 다시 입력해주세요." />
