...
<body style="background-color:#f5e9dd;">
...
<div class="contrainer-grid">
   <div style="margin-top:-12px; margin-left:-2px;">
      ...
      <nav class="navbar navbar-expand-md justify-content-center" style="font-weight:bold; height:50px; color:#000000;">
         <a class="navbar-brand" href="${pageContext.request.contextPath }/home.do" style="font-weight:bold; font-size:38px; margin-left:244px; font-family: 'Roboto', sans-serif;">
   ...
   <div class="row" style="margin-top:20px; margin-left:0px;"><!-- by 준익, 왼쪽 카테고리 검색과 메인페이지를 나누기 위한 row_2021.02.28 -->
      <div class="col-8 justify-content-center" style="width:auto;"><!-- by 준익, 메인 페이지 div_2021.02.28 -->
         <c:choose>
