...
<div class="contrainer">
	<div style="margin-top:0px; margin-left:-2px;">
		<nav class="navbar navbar-expand-lg justify-content-center" style="margin-left:30px;font-weight:bold; height:50px; color:#000000;">
			<form class="d-flex" action="${pageContext.request.contextPath }/bookList/conditionSearch.do" method="get">
		        <input class="form-control" type="text" aria-label="Search" style="margin-top:25px;font-weight:bold; border-width:3px; border-radius:20px; border-color:#135fa1; height:50px; width:500px;"
		        	name="keyword" value="${keyword }" />
		        <input name="pageNum" value="1" hidden/>
		        <input name="start" value="1" hidden/>
		        <button type="submit" style="margin-left:20px; font-weight:bold; border:0; outline:0;">
		        	<img style="margin-left:-20px; width:100px; height:100px;"src="${pageContext.request.contextPath }/resources/images/magnifier1.png"/>
		        </button>
		    </form>
		</nav>
	</div>
